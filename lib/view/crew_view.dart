          ...
          children: [
            ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return InkWell(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => DetailCrewView(crew: crewList[index])));
                    },
                    child: buildCard(index, crewList[index]),
                  );
                }),
